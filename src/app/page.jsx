    ...
    <main>
      ...
      <section className='container mx-auto'>
        <div className='grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-20 p-3'>
          ...
          <div className='bg-[#fff]-500 shadow-lg shadow-[#000]-900 p-4 py-6 rounded-lg'>
            <h1 className='text-[#3C3C3C] font-[700] text-[36px]  '>
              Save Life Donate Blood
            </h1>
            <p className='text-[#3C3C3C] text-[18px] '>
            ...
            <div className='mt-7'>
              <h1 className='text-[#3C3C3C] font-[700] text-[22px]  '>
                Why Donate Blood?
              </h1>
              <ul class='list-disc p-5 text-[#3C3C3C] text-[18px]'>
            ...
            <div className='text-end mt-2'>
              <button className='rounded-lg  bg-black shadow-lg p-2 text-white font-roboto font-[600] text-[16px]'>
                Get Blood Now
              </button>
            </div>
          </div>
        ...
        {/* Our mission */}
        <div className='bg-[#fff]-500 shadow-lg shadow-[#000]-900 p-5  mt-[90px] rounded-lg'>
          <h1 className='text-[#3C3C3C] font-[700] text-[36px]  '>
            Our Mission
          </h1>
          <p className='text-[#3C3C3C] text-[18px] mt-3 '>
